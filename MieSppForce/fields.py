...
def get_field(wl, eps_interp, alpha, phase, a_angle, stop, eps_particle, R,   r, phi, z, z0 ):
    ...
    point = [x,y,z]
    amplitude = 1
    E0, H0 = dipoles.initial_field(wl, alpha, amplitude, eps_interp, point, phase, a_angle)    
    ...
    p,m = dipoles.calc_dipoles_v2(wl, eps_interp, point, R, eps_particle, alpha, amplitude, phase, a_angle, stop)
